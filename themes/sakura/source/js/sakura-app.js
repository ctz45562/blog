...
function imgError (ele, type) {
  switch (type) {
    ...
    case 2:
      ...
      break
    case 3:
      ele.src = 'https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.7.1/emojis/menhera/24.jpg'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.7.1/emojis/menhera/24.jpg'
  }
...
function checkBgImgCookie () {
  ...
  if (!bgurl) {
    ...
    $('#banner_wave_2').addClass('banner_wave_hide_fit_skin')
  	...
  	if (bgurl == 'http://img.xjh.me/random_img.php?type=bg&ctype=nature&return=302' || bgurl == 'https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.3.4/theme-dark.jpg') {
		mashiro_global.variables.isNight = true
	}
	else {
		mashiro_global.variables.isNight = false
	}
	if(bgurl == 'https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.3.4/theme-dark.jpg'){
